...
LayoutManager::LayoutManager(): Manager(), m_previewMode(0), m_drawMode(0), m_useMask(true), m_moonSize(0), m_seaOpacity(0), m_numWindParticles(800), m_sizeWindParticles(6.0), m_cloudsOpacity(1.0), m_blurValue(0.0), m_fadeTimeWindParticles(8)
{
