...
uniform float cloudcover = 0.2; // Cloud Cover, min=0., max=1.
uniform float cloudalpha = 8.0; // Cloud Alpha, min=0., max=10.
uniform float skytint = 0.5; // Sky Tint
uniform vec3 skycolour1 = vec3(0.0, 0.0, 0.0); // Sky Color 1
uniform vec3 skycolour2 = vec3(0.0, 0.0, 0.0); // Sky Color 2
